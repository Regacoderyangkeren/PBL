...
fun AppTextField(
    ...
    val resolvedFocusedContainer =
        if (isError)
            MaterialTheme.colorScheme.errorContainer
        else focusedContainerColor
    val resolvedContent =
        if (isError)
            MaterialTheme.colorScheme.onErrorContainer
        else contentColor
    val resolvedFocusedContent =
        if (isError)
            MaterialTheme.colorScheme.onErrorContainer
        else focusedContentColor
    ...
    TextField(
        ...
        colors = appColorTextFieldAnim(
            ...
            selectedContainer = resolvedFocusedContainer,
            defaultContainer = resolvedContainer,
            selectedContent = resolvedFocusedContent,
            defaultContent = resolvedContent
        ),
